...
p <- ggplot(
  ...
  geom_line(size = 2) + scale_color_viridis_d() + labs(x = "Year", y = "Access to electricity (% of population)", 
                                                       title = "Access to electricity by region", subtitle = "From 2007 to 2016", caption = "Source: World Bank") + 
  facet_wrap(region~.) + theme_ipsum() + theme(legend.position = "none", plot.title = element_text(size = 8, hjust = 0.5, face = "bold"), strip.text = element_text(color = "white", face = "bold"), strip.background = element_rect(color = "white", fill="#168B8F", size=1.5, linetype="solid"))
